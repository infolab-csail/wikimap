...
def fraction_msg(msg, missed, total, thing):
    ...
    """
    return "{msg} {missed} {thing} out of {total} total, or {percent}".format(msg=msg, missed=str(int(missed)), thing=thing, total=str(int(total)), percent=percent_str(missed, total))
